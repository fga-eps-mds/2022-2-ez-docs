...
def main():
    ...
    parser.add_argument('--about', nargs=0, help='About our project', action=call_command_about)
    parser.add_argument('--architecture', nargs=0, help='Architecture stuff', action=call_command_architecture)
    parser.add_argument('--help', nargs=0, help='How to use it', action=call_command_help)
    parser.add_argument('--list', nargs=0, help='Command list', action=call_command_list)
